...
import com.gexin.artplatform.imagecache.utils.CrashApplication;;
...
//            imageView.setImageDrawable(null);
    ...
    private byte[] loadByteArrayFromNetwork(String url) {
        try {
            ...
            HttpResponse response = CrashApplication.getInstance().getHttpClient().execute(method);
    ...
    public String urlToFilePath(String url) {
        ...
        Log.v(TAG, "getInstanse"+(CrashApplication.getInstance()==null));
        // 图片存取路径
		filePath.append(CrashApplication.getInstance().getCacheDir().toString())
				.append('/');
        // 图片文件名
