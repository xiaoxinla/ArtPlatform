...
public class MyQuestionActivity extends Activity {
	...
	private String MyQuestion_API = Constant.SERVER_URL
			+ Constant.USER_API;
	...
	private void initView() {
		...
		mListView.setOnRefreshListener(new OnRefreshListener2<ListView>() {
			...
			public void onPullDownToRefresh(
				...
				String label = DateUtils.formatDateTime(MyQuestionActivity.this,
	...
	private void initData() {
		...
		String api = MyQuestion_API + "/" + (String) SPUtil.get(this, "userId", "") + "/problems";
		if(!userId.isEmpty()){
			api+="?userId="+userId;
		}
...
//			String prm = "?skip=" + problems.size();
	...
	private List<Problem> success(JSONObject jObject) {
		...
		String avatarUrl = (String) SPUtil.get(MyQuestionActivity.this, "avatarUrl", "");
